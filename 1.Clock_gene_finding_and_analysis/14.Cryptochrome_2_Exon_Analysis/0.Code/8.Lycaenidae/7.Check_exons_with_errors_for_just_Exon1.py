...
#             print(current_position, next_position)
            ...
            if error_exon_number == "1":
                ...
                if complement == "0":
                    fragment_start = int(final_coordinate_file_lines[current_position].split(",")[3])-50000
                ...
                if complement == "1":
                    ...
                    fragment_end = int(final_coordinate_file_lines[current_position].split(",")[2]) + 50000
