...
output_location = f"/data/projects/saubar/Working_folder_circadian_rhythm/14.Cryptochrome_2_Exon_Analysis/{family_group}"
        ...
        for records in genome_file:
            ...
            while True:
                ...
                if (records.seq[start-3:start-1]).lower() == "ag" and ag != "Y":
                    print((records.seq[start-3:start-1]), records.seq)
                    ag = "Y"
