...
list_of_species = ["Anthocharis_cardamines","Aporia_crataegi","Leptophobia_aripa","Pieris_brassicae","Pieris_mannii","Pieris_melete","Pieris_napi","Pieris_rapae","Leptidea_juvernica","Leptidea_reali","Leptidea_sinapis"]
query_species = "Pieris_napi"
