...
blast_location = f"/mnt/griffin/saubar/Working_folder_circadian_rhythm/15.Timeout_Exon_Analysis/{family_group}"
query_location = f"{blast_location}/1.Query"
list_of_files_1 = os.listdir(blast_location)
for file_name_1 in list_of_files_1:
    if "tblastn_" in file_name_1:
        name_split = file_name_1.split("_")
        query_species = f"{name_split[1]}_{name_split[2]}"[:-3]
#query_species = "Bicyclus_anynana"
print(f"query_species {query_species}")
