...
def sequence_extractor(Species, Scaff, reverse_c, start, end, frame = 1, trans = 1 ):
    ...
    fasta_file = SeqIO.parse(("F:/Genomes_2023-12-26/"+Species+"/"+Genome_name),'fasta')
...
blast_location = f"H:/My Drive/Circadian Rhythm Genes Project/10.Cycle Exon Analysis/{family_group}"
