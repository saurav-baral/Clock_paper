...
query_location = f"/mnt/griffin/saubar/Working_folder_circadian_rhythm/10.Cycle_Exon_Analysis/{family_group}/1.Query"
...
query_location = f"/mnt/griffin/saubar/Working_folder_circadian_rhythm/10.Cycle_Exon_Analysis/{family_group}/1.Query/{query_species}/{query_transcript}/query_protein.fa"
...
for species in list_of_species:
    ...
    if species not in blast_output_folders:
        os.mkdir(f"/mnt/griffin/saubar/Working_folder_circadian_rhythm/10.Cycle_Exon_Analysis/{family_group}/1.Blast_result/{species}")
...
with io.open(f"/mnt/griffin/saubar/Working_folder_circadian_rhythm/10.Cycle_Exon_Analysis/{family_group}/tblastn_{query_species}.sh", "w", newline='\n') as outfile:
