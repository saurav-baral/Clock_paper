...
```{r}
library(RERconverge)
setwd("C:/Users/sauba/Desktop/20.RERConverge_trimmed/unTrimmed/3.For_tree")
Trees=readTrees(paste('combined_trees_sp_rem.nwk',sep=""))
...
marineextantforeground = c("Anthocharis_cardamines","Aporia_crataegi","Argynnis_bischoffii_washingtonia","Aricia_artaxerxes","Aricia_agestis","Battus_philenor","Boloria_euphrosyne","Boloria_selene","Brenthis_hecate","Brenthis_daphne","Brenthis_ino","Calycopis_cecrops","Celastrina_argiolus","Coenonympha_glycerion","Cyaniris_semiargus","Danaus_plexippus","Erebia_aethiops","Erebia_ligea","Euphydryas_editha","Fabriciana_adippe","Glaucopsyche_alexis","Hipparchia_semele","Hypolimnas_misippus","Lasiommata_megera","Leptidea_juvernica","Leptidea_sinapis","Leptidea_reali","Lysandra_coridon","Lysandra_bellargus","Maniola_jurtina","Maniola_hyperantus","Melanargia_galathea","Melitaea_cinxia","Mellicta_athalia","Nymphalis_c-album","Nymphalis_polychloros","Nymphalis_urticae","Nymphalis_io","Oeneis_ivallda","Papilio_xuthus","Papilio_machaon","Papilio_glaucus","Pararge_aegeria","Parnassius_glacialis","Phengaris_arion","Pieris_napi","Pieris_mannii","Pieris_rapae","Pieris_brassicae","Pieris_melete","Plebejus_argus","Polyommatus_icarus","Polyommatus_iphigenia")
...
write.csv(corMarine, 'G:/My Drive/Circadian Rhythm Genes Project/20.RERconverge/4.Diapause_2Apr/correlation_2Apr2025_sp_rem.csv')
```

```{r}
plotRers(mamRERw,"period.fas.ClipKIT",phenv=phenvMarine)
```

```{r}
setwd("G:/My Drive/Circadian Rhythm Genes Project/20.RERconverge/3.Original_diapause")
pdf("relative_rate_plot_Period.pdf", width = 4, height = 4)
plotRers(mamRERw,"period.fas.ClipKIT",phenv=phenvMarine)
dev.off()
```
