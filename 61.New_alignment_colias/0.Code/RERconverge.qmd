...
```{r}
setwd("C:/Users/sauba/Desktop/20.RERConverge_trimmed/3.New_colias")
estimatePhangornTreeAll(alndir = "4.BUSCO_with_colias_fixed_aligned_trimmed_missing", treefile = "combined_file.fas.treefile_no_branch_length.nwk", output.file = "missing.tre")
```
...
write.csv(mamRERw, 'C:/Users/sauba/Desktop/20.RERConverge_trimmed/3.New_colias/61.New_alignment_colias/20.CLassification/rer_combined.csv')
...
corMarine$qvalue = qobj$qvalues

# write.csv(corMarine, 'C:/Users/sauba/Desktop/20.RERConverge_trimmed/3.New_colias/trees_split/correlation_24May2025.csv')
```

```{r}
plotRers(mamRERw,"period.fas.best.fas.ClipKIT",phenv=phenvMarine)
```
